...
function Cart() {
  ...
  function handleDelete(index) {
    // fetch(
    //   `https://sheet.best/api/sheets/882cbe2e-9fb7-4f3d-be5e-914412a24f68/${index}`,
    //   {
    //     method: "DELETE",
    //   }
    // ).catch((error) => {
...
//   },0)
  ...
  return (
    <>
      ...
      ) : (cartData==="Order Placed"?<EmptyCart currentstring="Hurray Order Placed"/>:<div className="cart"> 
      ...
      <motion.div initial={{ opacity: 0, x:50 }} animate={{opacity: 1, x: 0}} transition={{ duration: 1}} className="total-summary">
          <h2>Total:</h2>
          {/* <h2>{totalBill}</h2> */}
